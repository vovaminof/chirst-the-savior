...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.short_text_pl'
        db.add_column(u'resource_book', 'short_text_pl',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Book.short_text_en'
        db.add_column(u'resource_book', 'short_text_en',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.short_text_pl'
        db.delete_column(u'resource_book', 'short_text_pl')

        # Deleting field 'Book.short_text_en'
        db.delete_column(u'resource_book', 'short_text_en')
    ...
    models = {
        u'resource.book': {
            ...
            'short_text': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'short_text_en': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'short_text_pl': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
